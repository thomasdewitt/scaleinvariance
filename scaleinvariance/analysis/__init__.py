...
from .structure_function import structure_function, structure_function_hurst, costructure_function, structure_function_analysis
from .wavelets import WAVELETS, Wavelet, get_wavelet
from .wavelet_fluctuation import (wavelet_fluctuation, wavelet_fluctuation_hurst,
                                  haar_fluctuation, haar_fluctuation_hurst,
                                  haar_fluctuation_analysis)
