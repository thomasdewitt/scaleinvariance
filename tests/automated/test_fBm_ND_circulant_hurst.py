...
"""
import numpy as np
from scaleinvariance import fBm_2D_circulant, fBm_ND_circulant, haar_fluctuation_hurst
...
def test_fBm_2D_circulant():
    ...
    print("=" * 70)
    print("Testing fBm_2D_circulant Hurst estimation (Haar fluctuation)")
    ...
    for H_true in H_VALUES:
        ...
        for _ in range(N_REALIZATIONS_2D):
            fBm = fBm_2D_circulant((SIZE_2D, SIZE_2D), H_true, periodic=PERIODIC)
