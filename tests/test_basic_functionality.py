...
class TestFIFSimulations:
    ...
    def test_fif_non_nan_parameter_sweep(self):
        """Check FIF outputs remain non-NaN over a broader parameter range.
        This is designed to catch a rare nan occurence that was happening at one point
        so it needs a pretty large sample"""
