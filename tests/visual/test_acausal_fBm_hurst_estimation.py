...
from scaleinvariance import fBm_1D_circulant, structure_function_hurst, haar_fluctuation_hurst, spectral_hurst
...
size = 2**20
fBm1 = fBm_1D_circulant(size, H)
fBm2 = fBm_1D_circulant(size, H)
