...
from scaleinvariance import fBm_ND_circulant, haar_fluctuation_hurst, structure_function_hurst, spectral_hurst
...
if __name__ == "__main__":
    ...
    fbm_2d_rect = fBm_ND_circulant((int(size/2), size), H)
